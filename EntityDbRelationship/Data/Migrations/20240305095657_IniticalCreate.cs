...
namespace EntityDbRelationship.Migrations
{
    /// <inheritdoc />
    public partial class IniticalCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BackpackSet", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BackpackSet_Characters_CharacterId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BackpackSet_CharacterId",
                table: "BackpackSet",
                column: "CharacterId",
                unique: true);
